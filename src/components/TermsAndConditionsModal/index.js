...
export const TermsAndConditions = ({ isTermsAndConditions, toggleTermsAndConditions }) => {
    return (
        <Modal 
            title="Terms and Conditions" 
            visible={isTermsAndConditions} 
            onCancel={toggleTermsAndConditions}
            footer={null}
            centered={true}
        >
            <Content>
                <h2>Welcome to www.cdlhint.com!</h2>
                These terms and conditions outline the rules and regulations 
                for the use of CDL Hint Website, located at www.cdlhint.com.
                <br />
                By accessing this website we assume you accept these terms 
                and conditions. Do not continue to use www.cdlhint.com if 
                ...
                services, in accordance with and subject to, prevailing law of United States of America. 
                ...
                <br />
                <h2>Cookies</h2>
                We employ the use of cookies. By accessing www.cdlhint.com, you agreed 
                to use cookies in agreement with the CDL Hint Privacy Policy.
                <br />
                ...
                <br />
                <h2>License</h2>
                Unless otherwise stated, CDL Hint and/or its licensors own the 
                intellectual property rights for all material on www.cdlhint.com. 
                All intellectual property rights are reserved. You may access this 
                from www.cdlhint.com for your own personal use subjected to restrictions 
                set in these terms and conditions.
                <br />
                You must not:
                <ul>
                    <li>Republish material from www.cdlhint.com</li>
                    <li>Sell, rent or sub-license material from www.cdlhint.com</li>
                    <li>Reproduce, duplicate or copy material from www.cdlhint.com</li>
                    <li>Redistribute content from www.cdlhint.com</li>
                </ul>
                <br />
                ...
                <br />
                CDL Hint reserves the right to monitor all Comments and to 
                ...
                <br />
                You hereby grant CDL Hint a non-exclusive license to use, reproduce, edit 
                ...
                compensates the absence of CDL Hint; and (d) the link is in the context of 
                ...
                e-mail to CDL Hint. Please include your name, your organization name, 
                ...
                <br />
                No use of CDL Hint logo or other artwork will be allowed for linking absent
                a trademark license agreement.
                <br />
                <br />
                <h2>iFrames</h2>
                Without prior approval and written permission, you may not create frames around 
                our Webpages that alter in any way the visual presentation or appearance of our Website.
                <br />
                <br />
                ...
                also reserve the right to amen these terms and conditions and it's linking policy at 
